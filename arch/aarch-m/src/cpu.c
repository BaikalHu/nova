...
"       .syntax unified                                                      \n"
"                                                                            \n"
"       ldr     r1, =deferred_isr_q                                          \n"
"       mrs     r3, primask                                                  \n"
"       ldr     r2, [r1]                    @ r2 = head_idx                  \n"
"       adds    r2, %0                      @ r2 = head_idx + nr_elements    \n"
"                                                                            \n"
"       cpsid   i                                                            \n"
"                                                                            \n"
"       ldr     r0, [r1, #4]                @ r0 = tail_idx                  \n"
"       subs    r2, r0                      @ r2 = head_idx + nr_elements -  \n"
"                                           @      tail_idx                  \n"
"       beq     0f                          @ no free slots                  \n"
"                                                                            \n"
"       adds    r2, r0, #1                                                   \n"
"       str     r2, [r1, #4]                @ deferred_isr_q.tail_idx++      \n"
"                                                                            \n"
"       msr     primask, r3                                                  \n"
"       bx      lr                                                           \n"
"0:                                                                          \n"
...
"       bx      lr                                                           \n"
        :
        : "i" (CONFIG_NR_DEFERRED_IRQ_JOB_SLOTS)
        );
    }
