...
static int __cmd_event_test (cmder_t * cmder, int argc, char * argv [])
    ...
    task_spawn ("e6", 4, 0, 0x400, (int (*) (uintptr_t)) e6, 0);
    task_spawn ("e5", 4, 0, 0x400, (int (*) (uintptr_t)) e5, 0);
    task_spawn ("e4", 3, 0, 0x400, (int (*) (uintptr_t)) e4, 0);
    task_spawn ("e3", 2, 0, 0x400, (int (*) (uintptr_t)) e3, 0);
    task_spawn ("e2", 1, 0, 0x400, (int (*) (uintptr_t)) e2, 0);
    task_spawn ("e1", 0, 0, 0x400, (int (*) (uintptr_t)) e1, 0);
